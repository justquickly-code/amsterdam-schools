      ...
      <div className="mx-auto w-full max-w-4xl space-y-6">
        <header className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <h1 className="text-3xl font-serif font-semibold text-foreground">Sync open days</h1>
        ...
        <InfoCard title="What this does">
          <p className="text-sm text-muted-foreground">
            Imports open day listings and stores them as an annual snapshot. Always verify details on the school website.
          </p>
        </InfoCard>
